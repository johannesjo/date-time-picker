...
import { createKeyboardEvent, dispatchEvent, dispatchFakeEvent, dispatchKeyboardEvent, dispatchMouseEvent } from '../../test-helpers';
...
@Component({
  template: `
    <input [(ngModel)]="date"
           ...
           [owlDateTime]="dt"
           [owlDateTimeTrigger]="dt">
    <owl-date-time [showSecondsTimer]="true"
                   #dt></owl-date-time>
  `
})
...
@Component({
  template: `
    <input [(ngModel)]="selected"
           [owlDateTime]="dt">
    <owl-date-time (afterPickerOpen)="openedSpy()"
